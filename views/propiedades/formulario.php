 <fieldset>
     ...
     <input type="text" id="titulo" name="propiedad[titulo]" maxlength="18" placeholder="Titulo Propiedad" value="<?php echo s($propiedad->titulo); ?>" />

     <label for="precio">Precio:</label>
     <input type="number" id="precio" name="propiedad[precio]" placeholder="Precio Propiedad" value="<?php echo $propiedad->precio; ?>" />

     <label for="imagen">Imagen:</label>
     <input type="file" id="imagen" name="propiedad[imagen]" accept="image/jpeg, image/png" /><!-- El atributo "accept" nos añadir el formato de archivos que queremos permitir -->
